(function() {
    ...
    module.directive('fileItem', FileItemDirective);
    module.controller('FileItemController', FileItemController);

    function FileItemDirective() {
        return {
    ...
    function FileItemController($scope, $compile, $timeout) {
        var $elm;
